...
<head>
    ...
    <link rel="stylesheet" href="<?= base_url('assets/css/style_e_403.css') ?>">
...
<body>
    ...
    <div class="errortext">This area is forbidden. <a style="text-decoration: none;color:white;" href="<?= base_url('landing') ?>">Turn back now!</a></div>
</body>
